...
const orderData = {
    ordList:[
        {id:uuid(), shopname:'啃得起', foods:[{foodname:'tea1',foodprice:9},{foodname:'沙拉',foodprice:23.3},{foodname:'豆腐',foodprice:13.3},{foodname:'阔落',foodprice:3.3}], tel:'15678904397',status:'订单已送达'},
        ...
        {id:uuid(), shopname:'dd烤肉饭', foods:[{foodname:'tea1',foodprice:9},{foodname:'牛排',foodprice:23.3},{foodname:'奶茶',foodprice:13.3},{foodname:'阔落',foodprice:3.3}], tel:'18678904397',status:'订单已送达'},
